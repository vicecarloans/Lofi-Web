...
import { AnimatePauseIcon, AnimatePlayIcon, CloseIcon, DeleteIcon, DownloadIcon, FaMinusSquareOIcon, LoopIcon, LyricIcon, MdVolumeDownIcon, MdVolumeMuteIcon, NextAudioIcon, OrderPlayIcon, PlayLists, PrevAudioIcon, ReloadIcon, RepeatIcon, ShufflePlayIcon } from './components/Icon';
...
var ReactJkMusicPlayer = /*#__PURE__*/function (_PureComponent) {
  ...
  function ReactJkMusicPlayer(props) {
    ...
    _this.player = createRef();
    _this.destroyBtn = createRef();
    return _this;
  }
