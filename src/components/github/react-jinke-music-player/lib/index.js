...
export default class ReactJkMusicPlayer extends PureComponent {
    ...
    render() {
        ...
        const DownloadComponent = showDownload && (
            <span
                ...
                {...{
                    [isMobile ? "onTouchStart" : "onClick"]: this
                        .onAudioDownload,
                }}
                ...
                <div className={cls("music-player")}>
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                <div
                                    className={cls("music-player-backdrop")}
                                ></div>
    ...
    audioListsPlay = (playId, ignore = false, state = this.state) => {
        ...
        const loadAudio = (originMusicSrc) => {
            ...
            this.props.onPlayIndexChange &&
                this.props.onPlayIndexChange(playIndex);
        };
    ...
    clearAudioLists = () => {
        this.props.onAudioListsChange &&
            this.props.onAudioListsChange("", [], {});
        this.props.onAudioRemoved && this.props.onAudioRemoved();
    ...
    onDeleteAudioLists = (audioId) => (e) => {
        ...
        this.props.onAudioRemoved && this.props.onAudioRemoved(audioLists.find(audio => audio.id === audioId).key);
        this.props.onAudioListsChange &&
            this.props.onAudioListsChange(
                playId,
                newAudioLists,
    ...
    updatePlayIndex = (playIndex) => {
        ...
        if (playIndex !== undefined && currentPlayIndex !== playIndex) {
            const currentPlay = this.state.audioLists[
